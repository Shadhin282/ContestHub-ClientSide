    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="flex h-16 items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          {isAuthenticated && user ? <Dropdown trigger={<div className="flex items-center gap-3 hover:bg-slate-800/50 p-1.5 rounded-full pr-4 transition-colors border border-transparent hover:border-slate-700">
