...
export function ContestDetails() {
  ...
  useEffect(() => {
    ...
    const foundContest = MOCK_CONTESTS.find(c => c.id === id);
    if (foundContest) {
  ...
  const isRegistered = user && contest.participants.includes(user.id);
  ...
  const handleSubmissionSuccess = (link) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            {winner && <section className="bg-gradient-to-r from-yellow-900/20 to-orange-900/20 border border-yellow-500/30 rounded-xl p-8 text-center relative overflow-hidden">
